...
python3 create_experiment.py --compch 3 15 65  --outch 2 --grid false --maxvalue 3 7 --trainst false true --step null --datapath "/tigress/popovych/aligner/params/data/data_params_m2_noaugment.json"
